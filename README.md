...
| [docs/atlas/TRUST_OBJECT_MODEL.md](docs/atlas/TRUST_OBJECT_MODEL.md) / [docs/governance/CAPABILITY_MODEL.md](docs/governance/CAPABILITY_MODEL.md) / [docs/governance/ADAPTER_REGISTRY.md](docs/governance/ADAPTER_REGISTRY.md) / [docs/governance/POLICY_PLANE.md](docs/governance/POLICY_PLANE.md) / [docs/governance/APPROVAL_PLANE.md](docs/governance/APPROVAL_PLANE.md) | Actors, objects, capabilities, adapters, policy, approvals, schemas, freshness, verification, and replay. |

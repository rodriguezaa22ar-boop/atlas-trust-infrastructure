...
| [docs/atlas/TRUST_OBJECT_MODEL.md](docs/atlas/TRUST_OBJECT_MODEL.md) / [docs/governance/CAPABILITY_MODEL.md](docs/governance/CAPABILITY_MODEL.md) | Actors, objects, capabilities, schemas, freshness, verification, and replay. |

...
atlas_v1_collect_operation_readiness() {
  ...
  if ! atlas_v1_operation_loaded; then
    atlas_v1_add_pillar \
      ...
      "atlas finding add; atlas finding update; atlas finding accept; atlas finding review; atlas finding review-queue; atlas finding resolve" \
  ...
  if [ "$ATLAS_READINESS_OPEN_FINDINGS_COUNT" -gt 0 ]; then
    atlas_v1_add_pillar \
      ...
      "tests/atlas.bats finding lifecycle and accepted-risk tests" \
      "atlas finding list; atlas finding accept; atlas finding review; atlas finding review-queue; atlas finding resolve" \
    ...
    atlas_v1_add_pillar \
      ...
      "atlas finding list; atlas finding review; atlas finding review-queue; atlas op readiness" \
      "${ATLAS_OP_DIR}/findings.ndjson" \
